                                ...
                                <form action="{{ route('dashboard.products.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control ckeditor" name="{{$locale}}[description]" cols="20" rows="10">{{ old($locale .'.description') }}</textarea>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="form-group">
                                        <img src="{{ asset('uploads/product_images/default.png') }}" style="width: 200px" class="image-preview img-thumbnail"  alt="">
                                    </div>

                                    <div class="form-group">
                                        <label>@lang('site.purchase_price')</label>
                                        <input class="form-control" type="number" name="purchase_price" value="{{ old('sale_price') }}">
                                    </div>
